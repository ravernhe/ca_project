...
TARGET_COLUMNS = [
    "Origine rapport","Filiale First Finance","Code analytique (cf session)","Code analytique (pdt)","Code analytique",
    ...
    "Date prévisionnelle de début de projet","Date de fin de projet","StorageOpportuniteId",
